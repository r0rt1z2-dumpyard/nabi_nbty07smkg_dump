...
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][BSP][][]There is not the flashlight LED.
# CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][BSP][][].
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][]Add the new image sensor BF2205 and BF3905.
# CUSTOM_HAL_IMGSENSOR = ov5647_raw ov2659_yuv
CUSTOM_HAL_IMGSENSOR = bf2205_mipi_raw bf3905_mipi_yuv
##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][].
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][]Masked when the camera is fixed focus.
# CUSTOM_HAL_LENS = fm50af dummy_lens
CUSTOM_HAL_LENS = dummy_lens dummy_lens
##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][].
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][]Add the new image sensor BF2205.
# CUSTOM_HAL_MAIN_BACKUP_LENS =
# CUSTOM_HAL_MAIN_IMGSENSOR = ov5647_raw
# CUSTOM_HAL_MAIN_LENS = fm50af
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = bf2205_mipi_raw
...
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][]Add the new image sensor BF3905.
# CUSTOM_HAL_SUB_IMGSENSOR = ov2659_yuv
CUSTOM_HAL_SUB_IMGSENSOR = bf3905_mipi_yuv
##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][].
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_ACCELEROMETER = mxc400x
CUSTOM_KERNEL_ALSPS = 
#<2016/04/28-Diochang 
...
CUSTOM_KERNEL_IMGSENSOR = bf2205_mipi_raw bf3905_mipi_yuv
##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][CAMERA][][].
CUSTOM_KERNEL_KPD = kpd
##//<2016/04/28-Yuting Shih.[BD7][PORTING][MISC][BSP][][]Modified for the new LCM panel.
# CUSTOM_KERNEL_LCM = CPT_CLAP070WP03XG_LVDS
##//<2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][]Modified and add for the 2nd LCM panel source.
CUSTOM_KERNEL_LCM = ek79023a_wsvga_dsi_vdo hx8394d_wxga_dsi_vdo
##//>2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
##//>2016/04/28-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
...
CUSTOM_KERNEL_MAIN_BACKUP_LENS =
CUSTOM_KERNEL_MAIN_IMGSENSOR = bf2205_mipi_raw
...
##//<2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][]Modified and add for the 2nd LCM panel source.
CUSTOM_LK_LCM = ek79023a_wsvga_dsi_vdo hx8394d_wxga_dsi_vdo
##//>2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
##//>2016/04/28-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
CUSTOM_MODEM =
...
##//<2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][]Modified and add for the 2nd LCM panel source.
CUSTOM_UBOOT_LCM = ek79023a_wsvga_dsi_vdo hx8394d_wxga_dsi_vdo
##//>2016/08/05-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
##//>2016/04/28-Yuting Shih.[BD7][PORTING][MISC][BSP][][].
DCORE_TEST_MODE1 = no
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
#<2016/04/21-georgelin, [BD7][MISC][COMMON][CONFIG][][]Change LCM size to 1024X600.
LCM_HEIGHT = 1024
LCM_WIDTH = 600
#>2016/04/21-georgelin
...
#<2016/05/03-tedwu, [BD7][FEATURE][COMMON][BSP][][]Add device driver of charger IC BQ24157S
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ABD7TY20160831A00
MTK_BWC_SUPPORT = yes
...
MTK_EPDG_SUPPORT = no
MTK_ETWS_SUPPORT = no
#<2016/07/05-kanewang, [BD7][FEATURE][COMMON][USB][][]Disable MTK_EXTERNAL_DONGLE feature.
...
#<2016/05/27-georgelin, [BD7][MISC][COMMON][APPS][][]Remove MTK preload APK.
MTK_FILEMANAGER_APP = no
#>2016/05/27-georgelin
MTK_FIRST_MD = 1
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
MTK_FLV_PLAYBACK_SUPPORT = yes
#<2016/06/17-HenryPeng,[BD7][MISC][COMMON][GPS][][]Removed the FM and GPS.
MTK_FMRADIO_APP = no
...
##//<2016/06/22-Yuting Shih.[BD7][MISC][COMMON][LCM][][]SW Requirements - Requirements of System UI.
MTK_LCM_PHYSICAL_ROTATION = 270
##//>2016/06/22-Yuting Shih.[BD7][MISC][COMMON][LCM][][].
...
#<2016/04/22-georgelin, [BD7][MISC][COMMON][CTS][][]Add release key.
MTK_SIGNATURE_CUSTOMIZATION = yes
#>2016/04/22-georgelin
...
#CREATE_PROJECT_INFO=20160415153729
##//<2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][BSP][][]Add for Arima project.
##*********************************************
## ARIMA Project
##*********************************************
ARIMA_PROJECT_NAME  = ARIMA_PROJECT_BD7

##//>2016/05/02-Yuting Shih.[BD7][PORTING][COMMON][BSP][][].
#//<2016/5/5-rickjiau,[BD7][PORTING][COMMON][ATCOMMAND][][]Turn on AT command on official build and add AT command for production test on MMI SW download statge.  
